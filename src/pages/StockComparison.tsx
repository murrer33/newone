...
import { popularStocks, generateHistoricalData } from '../utils/mockData';
        ...
        {selectedStocks.length > 0 && (
          <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
            <p className="text-sm text-blue-700 dark:text-blue-400">
              Chart shows percentage change from the beginning of the selected time period. This allows for easier comparison of stocks with different price ranges.
            </p>
          </div>
        )}
      </div>
